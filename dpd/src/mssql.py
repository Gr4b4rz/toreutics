...
def get_active_transactions() -> list[Transaction]:
    ...
    transactions_query = """
    select tr_Nazwa, kh_Symbol, kh_EMail, dok_WartBrutto, adr_Nazwa, adr_Telefon, adr_Adres, adr_Kod, adr_Miejscowosc, adr_TypAdresu
    from tr__Transakcja
    ...
    for trans in results:
        ...
        transactions.append(
            Transaction(name=trans["tr_Nazwa"].strip(),
